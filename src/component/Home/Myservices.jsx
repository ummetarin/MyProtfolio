...
const Myservices = () => {
    return (
       ...
       <div className="bg-white w-[400px] h-[400px]">
           ...
           <p className="text-center font-bold px-10  text-orange-800 text-sm">Web design involves creating the visual aspect of a website, including the layout, colors, layout, and overall aesthetics. Here are some key aspects and principles to consider when designing a website</p>
          </div>
       </div>
       <div>
       <div className="bg-white w-[400px] h-[400px]">
           ...
           <p className=" px-10 text-center font-bold text-orange-800 text-sm">Web development involves building and maintaining websites or web applications. It encompasses a range of tasks, from designing the user interface to programming the backend functionality.</p>
          </div>
       </div>
